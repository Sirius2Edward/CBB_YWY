...
//        [self sortValueArr:valueArr colorArr:colorArr];
        ...
        self.centerView.frame = CGRectMake((frame.size.width - centerImage.size.width/1.5)/2, (frame.size.height - centerImage.size.height/1.5)/2, centerImage.size.width/1.5, centerImage.size.height/1.5);
        int titleWidth = 65;
        self.title = [[UILabel alloc]initWithFrame:CGRectMake((centerImage.size.width/1.5 - titleWidth)/2,23 , titleWidth, 17)];
        ...
        int amountWidth = 75;
        self.amountLabel = [[UILabel alloc]initWithFrame:CGRectMake((centerImage.size.width/1.5 - amountWidth)/2, 39, amountWidth, 22)];
